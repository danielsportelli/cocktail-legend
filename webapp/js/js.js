    ...
    function openModal(code){
      ...
      sheet.innerHTML =
        ...
        '<div style="display:flex;align-items:center;gap:.5rem;background:var(--bg);border:1px solid var(--brd);border-radius:10px;padding:.6rem .75rem;margin-bottom:1rem;">'+
          ...
          '<button id="invite-copy-btn" style="flex-shrink:0;background:none;border:none;color:var(--amber);font-size:.68rem;font-weight:700;font-family:inherit;cursor:pointer;padding:.2rem .4rem;-webkit-tap-highlight-color:transparent;">COPIA</button>'+
        '</div>'+
        // WhatsApp
